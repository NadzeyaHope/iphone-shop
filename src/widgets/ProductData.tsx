...
import {ColorsProduct, VariantsProduct} from "./CardOfProduct";
...
const ProductData = (props: Props) => {
    const {params, key, startPrice, variants, startColor, startStorage, colors, title, image} = props;
    ...
    return (
        <div key={key} className={'block md:flex relative'}>
